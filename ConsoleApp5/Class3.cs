...
namespace ConsoleApp5
{
    internal class Class3
    {
        void Run()
        {
            Console.WriteLine(GetPartNumberSum1(@"........440...............418..643.....438......740.261......................................727...........................870..............
...
...............................................657..........................423..........742.367...............................634.........."));
            ...
            Console.WriteLine(GetPartNumberSum1(@"467..114..
...*......
..35..633.
......#...
617*......
...
.664.598.."));
        ...
        long GetPartNumberSum1(string mapStr)
        {
            long result = 0;

            string[] values = mapStr.Split('\n');
            char[][] map = new char[values.Length][];

            for (int i = 0; i < values.Length; i++)
            {
                map[i] = values[i].Trim().ToArray();
            }

            bool numberIsPart = false;
            string numberStr = string.Empty;
            KeyValuePair<int, int>? starPos = null;
            Dictionary<KeyValuePair<int, int>, int> starValueMap = new();
            for (int i = 0; i < map.Length; i++)
            {
                for (int j = 0; j < map[i].Length; j++)
                {
                    if (char.IsDigit(map[i][j]))
                    {
                        ...
                        if (!numberIsPart)
                        {
                            ...
                            for (int k = 0; k < 9; k++)
                            {
                                int x = startX + k / 3;
                                int y = startY + k % 3;
                                if (x < 0 || x >= map[i].Length || y < 0 || y >= map.Length)
                                {
                                    continue;
                                }
                                if (map[y][x] == '*')
                                {
                                    starPos = new KeyValuePair<int, int>(y, x);
                                    break;
                                }
                            }
                        }
                    ...
                    {
                        if (starPos.HasValue && !string.IsNullOrWhiteSpace(numberStr))
                        {
                            if (starValueMap.ContainsKey(starPos.Value))
                            {
                                result += int.Parse(numberStr) * starValueMap[starPos.Value];
                                starValueMap.Remove(starPos.Value);
                            }
                            else
                            {
                                starValueMap.Add(starPos.Value, int.Parse(numberStr));
                            }
                            starPos = null;
                        }
                        numberIsPart = false;
        ...
        int GetPartNumberSum(string mapStr)
        {
            int result = 0;
            ...
            for (int i = 0; i < map.Length; i++)
            {
                for (int j = 0; j < map[i].Length; j++)
                {
                    if (char.IsDigit(map[i][j]))
                    {
                        ...
                        if (!numberIsPart)
                        {
                            ...
                            for (int k = 0; k < 9; k++)
                            {
                                ...
                                if (map[y][x] != '.' && !char.IsDigit(map[y][x]))
                                {
                                    numberIsPart = true;
                                    break;
                                }
                    ...
                    {
                        if (numberIsPart && !string.IsNullOrWhiteSpace(numberStr))
                        {
